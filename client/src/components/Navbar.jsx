      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <div className="flex space-x-4">
            ...
            <Link
              href="/signup"
              className="px-4 py-2 bg-lime text-white rounded hover:bg-blue-700 transition"
            >
              Sign Up
            </Link>
          </div>
      ...
      >
        ...
        <div className="px-6 mt-6 flex flex-col space-y-4">
          ...
          <Link
            href="/signup"
            onClick={() => setMenuOpen(false)}
            className="text-center px-4 py-2 bg-lime-500 text-white rounded hover:bg-blue-700 transition"
          >
            Sign Up
          </Link>
        </div>
