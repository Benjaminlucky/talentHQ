        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-9 pr-3 py-3 text-sm border rounded-xl focus:outline-none focus:ring-2 focus:ring-lime-400 bg-gray-50 focus:bg-white ${confirm && password !== confirm ? "border-red-300" : "border-gray-200"}`}
            />
          </div>
