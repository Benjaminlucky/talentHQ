"use client";
// src/app/handyman-signin/page.jsx
...
export default function HandymanSignin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user.role !== "handyman") {
        setError(
          "This sign-in is for handymen. Please use the correct login page.",
        );
        setLoading(false);
        return;
      }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Handyman sign in</p>
        </div>
